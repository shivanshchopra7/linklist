        ...
        <html lang="en">
            ...
            >
                ...
                <main className="md:flex min-h-screen">
                    <aside className="border-r-2 w-48 pt-6 shadow fixed md:static left-0 top-0 bottom-0 z-20 p-4 flex flex-col justify-between">
                        <div className="sticky top-0 pt-2">
                            <div className="flex flex-col gap-4 items-center">
                                ...
                                <h1 className="text-center text-2xl font-bold text-white">{session.user.name}</h1>
                                ...
                                {page && (
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-lg text-white">{page.uri}</span>
                                    </Link>
                                )}
                            </div>
                        ...
                        {/* Droppp.link span at the bottom */}
                        <div className="p-2 rounded-full border text-center mb-4">
                        <span className="font-bold text-white lowercase tracking-tight transform text-xl ">
                            droppp.link
                        </span>
                        </div>
